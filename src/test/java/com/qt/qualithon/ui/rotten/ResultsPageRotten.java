 ...
 **/
public class ResultsPageRotten extends Page{

    public ResultsPageRotten(TestSession testSession){
        super(testSession);
    }
     ...
     **/
    public MoviePageRotten firstMovieResult(){
        this.movieResultLinks().get(0).click();
        return new MoviePageRotten(this.testSession);
    }
}
